        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          <div className="max-w-full lg:max-w-[536px] flex flex-col gap-8">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
              <Button className="h-10 px-3 sm:px-4 text-xs sm:text-sm font-medium shadow-lg bg-azure hover:bg-azure/90 text-white transition-colors">
                <Chrome className="h-4 w-4" />
                Add to Chrome - Gratis
              </Button>
              <Button variant="outline" className="h-10 px-3 sm:px-4 text-xs sm:text-sm font-medium shadow-lg border-gold text-gold hover:bg-gold/5 transition-colors">
              ...
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-6 sm:w-8 h-6 sm:h-8 rounded-full border-2 border-background bg-gold"
                    ></div>
                  ))}
                </div>
          ...
          <div className="max-w-full lg:max-w-[536px] flex items-center justify-center w-full lg:w-auto">
            <div className="relative w-full">
              <div className="w-full bg-white rounded-xl sm:rounded-2xl shadow-xl sm:shadow-2xl p-4 sm:p-8 flex flex-col gap-4 sm:gap-6 relative rotate-1 sm:rotate-2">
                ...
                <div className="flex items-start gap-2 sm:gap-3 relative z-10">
                  <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-full bg-linkBlue flex items-center justify-center text-white font-semibold text-xs sm:text-sm">
                    JD
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold text-azure text-sm sm:text-base">Jan de Vries</h3>
                ...
                <div className="bg-background border border-gold/20 rounded-lg sm:rounded-xl p-3 sm:p-4 relative z-10">
                  <p className="text-xs sm:text-sm text-grey italic">
